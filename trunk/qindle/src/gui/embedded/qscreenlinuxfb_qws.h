...
#include <QTimer>
#include <QRect>
#define EINK_UPDATE_INTERIAL 200
#define _EINK_UPDATE_DISPLAY_PART 1
#define _EINK_UPDATE_DISPLAY_FULL 2
#define _EINK_UPDATE_DISPLAY_AREA 3
#define _EINK_UPDATE_DISPLAY_FX 7
...
class Qeink : public QObject
{
Q_OBJECT
public:
    Qeink();
    ~Qeink();
    void fbupdate(const QRect & rect);
private:
    int einkfd;
    QTimer *timer;
    QRect *reflashrect;
