 ...
 */
QDebug kDebugStream(QtMsgType level, int area, const char *file = 0,
 ...
 * @see perror(3)
 */
QDebug perror(QDebug, KDebugTag);
...
static inline QDebug kdDebug(int area = KDE_DEFAULT_DEBUG_AREA) { return kDebug(area); }
static inline QDebug kdWarning(int area = KDE_DEFAULT_DEBUG_AREA) { return kWarning(area); }
static inline QDebug kdError(int area = KDE_DEFAULT_DEBUG_AREA) { return kError(area); }
static inline QDebug kdFatal(int area = KDE_DEFAULT_DEBUG_AREA) { return kFatal(area); }
